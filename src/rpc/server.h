...
extern UniValue setzbtconeseed(const UniValue& params, bool fHelp);
extern UniValue getzbtconeseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbtcone(const UniValue& params, bool fHelp);
extern UniValue dzbtconestate(const UniValue& params, bool fHelp);
