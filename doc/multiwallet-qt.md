...
In order to support loading of multiple wallets in bitcoinone-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinone.cpp.
...
Changes to bitcoinone.cpp
----------------------
bitcoinone.cpp is the entry point into bitcoinone-qt, and as such, will require some minor modifications to provide hooks for
