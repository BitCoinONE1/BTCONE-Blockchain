...
#   c) node1 mines 32 blocks, so now node 0 has 60001btcone, node 1 has 4250btcone, node2 has none.
#   d) node0 sends 601 btcone to node2, in two transactions (301 btcone, then 300 btcone).
