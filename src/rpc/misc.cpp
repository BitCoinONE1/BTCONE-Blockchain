...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zBTCONEsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBTCONE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBTCONE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBTCONE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBTCONE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBTCONE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBTCONE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBTCONE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBTCONE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBTCONE denominations\n"
            "  }\n"
    ...
    UniValue zbtconeObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zbtconeObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zbtconeObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zBTCONEsupply", zbtconeObj));
