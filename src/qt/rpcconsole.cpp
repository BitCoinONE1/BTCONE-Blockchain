                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBTCONEPathCustom = GetArg("-zbtconebackuppath", "");
    ...
    if(!strzBTCONEPathCustom.empty()) {
        ui->wallet_customzbtconebackuppath->setText(QString::fromStdString(strzBTCONEPathCustom));
        ui->wallet_customzbtconebackuppath_label->setVisible(true);
        ui->wallet_customzbtconebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBTCONEPathCustom.empty()) && nCustomBackupThreshold > 0) {
