...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bitcoinone", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinone", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinone", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinone", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinone", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinone", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinone", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinone", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinone", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinone", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinone", "checkbudgets", &checkbudgets, true, true, false},
        ...
        {"zerocoin", "getzbtconeseed", &getzbtconeseed, false, false, true},
        {"zerocoin", "setzbtconeseed", &setzbtconeseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbtcone", &searchdzbtcone, false, false, true},
        {"zerocoin", "dzbtconestate", &dzbtconestate, false, false, true}
