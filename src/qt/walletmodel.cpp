...
static void NotifyzBTCONEReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzBTCONEReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzBTCONEReset.connect(boost::bind(NotifyzBTCONEReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzBTCONEReset.disconnect(boost::bind(NotifyzBTCONEReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zbtconeTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus);
}
