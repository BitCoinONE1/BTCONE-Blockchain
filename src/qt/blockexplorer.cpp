...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#0a0275;}\n a, span { font-family: monospace; }\n span.addr {color:#0a0275; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #0a0275;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#0a0275;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#0a0275;}\n";
